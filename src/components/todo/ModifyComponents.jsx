...
const ModifyComponent = ( {tno} ) => {
  ...
  const handleClickModify = () => {
    putOne(todo).then( data => {
      console.log( "modfiy result : " + data );
      setResult( 'Modified' );
    })
  }
    ...
    <div className="border-2 border-sky-200 mt-10 m-2 p-4">
      ...
      <div className="flex justify-center">
        <div className="relative mb-4 flex w-full flex-wrap items-stretch">
          ...
          <input className="w-4/5 p-6 rounded-r border border-solid border-neutral-300 shadow-md" name="title" type={'text'} value={todo.title || ""}
      ...
      <div className="flex justify-center">
        <div className="relative mb-4 flex w-full flex-wrap items-stretch">
          ...
          <input className="w-4/5 p-6 rounded-r border border-solid border-neutral-300 shadow-md" name="due_date" type={'date'} value={todo.due_date || ""}
          onChange={handleChangeTodo}></input>
        </div>
      </div>
